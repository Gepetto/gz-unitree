...
sim logfile="with_imu_on_model.log":
    ...
    LD_LIBRARY_PATH="/usr/local/lib/gz-unitree:/usr/local/lib/gz-video-recorder${LD_LIBRARY_PATH:+:$LD_LIBRARY_PATH}" CYCLONEDDS_URI="{{dds_config}}" GZ_SIM_SYSTEM_PLUGIN_PATH=/usr/local/lib/gz-unitree/ GZ_GUI_PLUGIN_PATH=/usr/local/lib/gz-video-recorder gz sim {{sdf_path}} -v 4
