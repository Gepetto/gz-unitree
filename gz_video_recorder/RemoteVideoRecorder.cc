...
/////////////////////////////////////////////////
void RemoteVideoRecorderPrivate::OnRender()
{
  this->Initialize();

  // record video is requested
  {
    GZ_PROFILE("RemoteVideoRecorder Record Video");
    if (this->recordVideo)
    {
...
/////////////////////////////////////////////////
void RemoteVideoRecorder::LoadConfig(const tinyxml2::XMLElement * _pluginElem)
{
  if (this->title.empty())
...
/////////////////////////////////////////////////
void RemoteVideoRecorder::OnStart(const QString &_format)
{
  std::unique_lock<std::mutex> lock(this->dataPtr->recordMutex);
...
/////////////////////////////////////////////////
void RemoteVideoRecorder::OnStop()
{
...
/////////////////////////////////////////////////
void RemoteVideoRecorder::OnSave(const QString &_url)
{
